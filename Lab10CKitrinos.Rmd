---
title: "Lab10 CKitrinos Markdown"
...
## Opening and Examining the Data set
...
## Converting VCF data to genlight objects
...
# Set all samples in the gemlight object to same ploidy
...
# Summarize the Object's contents

```{r}
chrom
```

# Plot Read Depth / Mapping Quality etc
...
#chromoqc plot showing nucleotides

```{r}
chromoqc(chrom, dp.alpha = 66)
```

# Create a ChromR object and compare to the above data
...
# 1) You actually have everything you need to make a Manhattan plot. Can you figure out how to plot G′ST
 (y-axis) by genomic position (POS)?

```{r}
plot(getPOS(vcf), myDiff$Gprimest,  pch = 20, col = "#1E90FF30", xlab = "", ylab = "", ylim = c(0, 1), xaxt = "n")
